function status = watching_and_select(win, constants, images_file, possible_answers,...
    corecct_answer, watching_period, text_size, select_period)
    ...
    im_size = constants.screen_rec(4)/2;
