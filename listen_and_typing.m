function  status=listen_and_typing(win, pahandle, constants, audio_file, correct_answer)
    symbol_size = [570 400];
    ...
    DrawFormattedText(win, 'Listen and typing!', 'center', constants.screen_rec(4)/2 + symbol_size(2)/3 + 40,...
        constants.TEXTS_COLOR, constants.TEXT_WRAPAT);
    Screen('Flip', win);
    WaitSecs(2)
    
    DrawFormattedText(win, 'Listen carefully and typing what you hear!\nPress enter when you typed!', 'center', constants.screen_rec(4)/6,...
    ...
    WaitSecs(.5);
    DrawFormattedText(win, 'Listen carefully and typing what you hear!\nPress enter when you typed!\n\n\n Again', 'center', constants.screen_rec(4)/6,...
        constants.TEXTS_COLOR);
    Screen('Flip', win)
