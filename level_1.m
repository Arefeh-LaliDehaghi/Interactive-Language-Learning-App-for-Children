function [levels_info, info] = level_1(win, constants,info,levels_info, pahandle)
    symbol_size = [250 400];
    ...
    WaitSecs(1)
    levels_info{1}.score = 100;
    levels_info{1}.status = 'completed';
    levels_info{1}.color = [0,255,0];
